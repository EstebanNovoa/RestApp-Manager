        ...
        <div className="w-screen h-screen">
            ...
            <div className="w-full h-full">
                ...
                <div className="text-center h-full  w-full">
                    <ButtonB text='Eliminar' id='btnDeleteItemMenu' link="../manageMenu" event={onClickDeleteProduct}></ButtonB>
                </div>
                </div>
            }></SubHeaderAdmin>
            }</div>
...
function onClickDeleteProduct(){
    let data = {
            name:document.getElementById('inpItemNameDelete').value,
    };
     fetch('http://localhost:8080/api/admin/products/delete/2', /*Poner endpoint delete product*/{
     method: 'POST', // or 'PUT'
